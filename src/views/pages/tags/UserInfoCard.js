...
const UserInfoCard = ({ selectedUser }) => {
  ...
  const is_active = {
    ...
    false: {title: 'In Active', color: 'light-warning'}
  }
            ...
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                ...
                <li className='mb-75'>
                  ...
                  <Badge className='text-capitalize' color={is_active[selectedUser.is_active].color}>
                    {is_active[selectedUser.is_active].title}
                  </Badge>
                </li>
