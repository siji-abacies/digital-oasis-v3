...
const ForgotPasswordV1 = () => {
  ...
  const onSubmit = data => {
    ...
    const config = {
      method: 'post',
      url: `https://digital-oasis-dev.herokuapp.com/v3/user/forgot_password`,
      headers: { 
    ...
    .then(function (response) {
      ...
      if (response.data.status === 200) {
        setmessageContent('An email with the password reset link has been sent to your email address.')
            ...
            <Form className='auth-forgot-password-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              <FormGroup>
                ...
                <Input
                    ...
                    placeholder='bruce.wayne@email.com' autoFocus
                  />
              </FormGroup>
