...
const DataTableWithButtons = () => {
  ...
  return (
    <Fragment>
      ...
      <Modal isOpen={setPrivilege} toggle={() => setShowPrivilege(!setPrivilege)} className='modal-dialog-centered modal-lg'>
        <ModalHeader className='bg-transparent' toggle={() => setShowPrivilege(!setPrivilege)}></ModalHeader>
        <ModalBody className='px-sm-5 pt-50 pb-5'>
          <div className='text-center mb-2'>
